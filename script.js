...
const restweather = () => {
  ...
  fetch("https://restcountries.com/v2/all")
    ...
    .then(function (data) {
      let result = `<h2 style="color:white; text-align:center;"> Countries and their Weather</h2>`; 
      data.forEach((info, id) => {
        const { name, flag, capital, region, countrycode } = info;
        result +=
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    ...
                                    <img  class="rounded mx-auto d-block card-img" src=${flag}  id="flag" alt="Countries-Flag">
                                        ...
                                        <h4> Region :  ${region} </h4>
                                        <h4> Country-Code: ${countrycode} </h4>
                                        <button class="btn btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample${id}
                                        " aria-expanded="false" aria-controls="collapseExample" onclick="weatherData()">
                                               Click for Weather
                                        </button>
